...
- Mapping to Claude happens in `packages/joyful-cli/src/claude/utils/permissionMode.ts`:
...
`packages/joyful-app/sources/sync/storage.ts`
...
`packages/joyful-app/sources/sync/persistence.ts`

If draft permission mode is missing:
- Draft default: `default`

### 3) New session UI defaults
`packages/joyful-app/sources/app/(app)/new/index.tsx`
`packages/joyful-app/sources/components/NewSessionWizard.tsx`
...
`packages/joyful-app/sources/sync/sync.ts`
...
`packages/joyful-cli/src/claude/runClaude.ts`
`packages/joyful-cli/src/claude/utils/permissionMode.ts`
...
`packages/joyful-cli/src/claude/claudeLocal.ts`
