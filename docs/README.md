...
This folder documents how Joyful works internally, with a focus on protocol, backend architecture, deployment, and the CLI tool. Start here.
...
- joyful-wire.md: Shared wire schemas/types package and migration notes.

## Conventions
- Paths and field names reflect the current implementation in `packages/joyful-server`.
