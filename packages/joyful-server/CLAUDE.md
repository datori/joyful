# Joyful Server - Development Guidelines

This document contains the development guidelines and instructions for the Joyful Server project. This guide OVERRIDES any default behaviors and MUST be followed exactly.

## Project Overview

**Name**: joyful-server  
**Repository**: https://github.com/slopus/joyful-server.git  
**License**: MIT  
**Language**: TypeScript  
**Runtime**: Node.js 20  
...
- **Tell**: Wrong server URL = check `JOYFUL_SERVER_URL` env var
- **Tell**: Wrong home dir = check `JOYFUL_HOME_DIR` (should be `~/.joyful-dev` for local)
