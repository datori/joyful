...
const STABLE_DIR = path.join(os.homedir(), '.joyful');
const DEV_DIR = path.join(os.homedir(), '.joyful-dev');
...
# Automatically sets JOYFUL_HOME_DIR based on directory
#
# To use: cd to happy-cli-dev directory, run: direnv allow
export JOYFUL_HOME_DIR="$HOME/.joyful-dev"
export JOYFUL_VARIANT="dev"
`;
