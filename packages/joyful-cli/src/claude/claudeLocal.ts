...
export async function claudeLocal(opts: {
    ...
    // We intercept these flags to use joyful-cli's session storage rather than Claude's default
    //
    // Supported patterns:
    ...
    try {
        ...
        await new Promise<void>((r, reject) => {
            ...
            if (!claudeCliPath || !existsSync(claudeCliPath)) {
                throw new Error('Claude local launcher not found. Please ensure JOYFUL_PROJECT_ROOT is set correctly for development.');
            }
