 ...
 * - File output location: ~/.joyful/logs/<date time in local timezone>.log
 */
...
class Logger {
  ...
  constructor(
    ...
    if (process.env.DANGEROUSLY_LOG_TO_SERVER_FOR_AI_AUTO_DEBUGGING 
      && process.env.JOYFUL_SERVER_URL) {
      this.dangerouslyUnencryptedServerLoggingUrl = process.env.JOYFUL_SERVER_URL
