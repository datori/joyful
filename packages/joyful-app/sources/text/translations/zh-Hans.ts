...
export const zhHans: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        codexConversationId: 'Codex 对话 ID',
        codexConversationIdCopied: 'Codex 对话 ID 已复制到剪贴板',
        ...
        failedToCopyCodexConversationId: '复制 Codex 对话 ID 失败',
        ...
        worktreeCleanupFailed: ({ path }: { path: string }) => `工作树清理失败。可能需要手动删除：${path}`,
        worktreeSection: '工作树',
        worktreeBranch: '分支',
        worktreeBasePath: '基础仓库',
        mergeToMain: '合并到主分支',
        mergeToMainSubtitle: '将此分支合并到基础仓库',
    },
    ...
    mergeWorktree: {
        title: '合并到主分支',
        preview: '待合并的更改',
        commits: ({ count }: { count: number }) => `${count} 个提交`,
        noChanges: '没有可合并的更改',
        loadingDiff: '正在加载差异...',
        viewFullDiff: '查看完整差异',
        fullDiffTitle: '完整差异',
        squashMerge: 'Squash 合并（推荐）',
        regularMerge: '常规合并',
        squashDescription: '将所有提交合并为基础分支上的一个干净提交',
        regularDescription: '保留工作树分支的完整提交历史',
        commitMessageLabel: '提交消息',
        commitMessageDefault: ({ branchName }: { branchName: string }) => `代理任务: ${branchName}`,
        mergeButton: '合并',
        merging: '合并中...',
        successTitle: '合并成功',
        conflictTitle: '合并冲突',
        conflictMessage: '合并遇到冲突已被中止。请在终端中手动解决冲突。',
        conflictFilesLabel: '冲突文件',
        worktreeDirtyMessage: '工作树有未提交的更改。请在合并前提交或丢弃这些更改。',
        baseDirtyMessage: '基础仓库有未提交的更改。请在合并前提交或丢弃这些更改。',
        cleanupTitle: '清理工作树？',
        cleanupMessage: '合并成功。是否要删除工作树目录和分支？',
        cleanupConfirm: '删除工作树和分支',
        openspecUnarchivedTitle: '未归档的 OpenSpec 更改',
        openspecUnarchivedMessage: '以下 OpenSpec 更改尚未归档。建议在合并前先归档，以确保规格文件是最新的：',
        openspecArchiveFirst: '先归档（推荐）',
        openspecProceedAnyway: '仍然继续',
        specDivergenceTitle: '规格文件已分歧',
        specDivergenceMessage: '自此工作树分支以来，主分支上的 openspec/specs/ 目录已被更新。现在合并可能会在规格文件上产生冲突。',
        specPullResync: '拉取主分支并重新同步',
        specPullResyncDescription: '将主分支拉取到此分支，然后提示运行 /opsx:sync 以协调规格冲突。',
        specMergeAnyway: '仍然合并',
        specAfterPullMessage: '拉取主分支后，在此会话中运行 /opsx:sync 以解决规格冲突，然后重试合并。',
        pullMainSuccess: '主分支拉取成功。运行 /opsx:sync 以协调规格冲突。',
        pullMainFailed: '拉取主分支失败',
        orphanTitle: '孤立工作树',
        orphanNoSession: '无活跃会话',
        orphanCleanup: '清理',
        orphanCleanupAll: '全部清理',
        orphanDirtyTitle: '未提交的更改',
        ...
        syncSpecsWithAI: '使用AI同步规格',
        syncSpecsWithAISubtitle: '恢复会话以更新实现以符合当前规格',
        fetchingSpecDiff: '正在获取规格差异...',
    },
} as const;
