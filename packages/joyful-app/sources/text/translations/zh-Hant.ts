...
export const zhHant: TranslationStructure = {
    ...
    newSession: {
        ...
        worktree: {
            ...
            pickWorktree: '選擇工作樹',
            createNew: '建立新工作樹',
            existingWorktrees: '現有工作樹',
            noActiveSession: '無活躍工作階段',
            loadingWorktrees: '正在載入工作樹...',
            orphaned: '孤立',
        },
    ...
    sessionInfo: {
        ...
        codexConversationId: 'Codex 對話 ID',
        codexConversationIdCopied: 'Codex 對話 ID 已複製到剪貼簿',
        codexContinuity: 'Codex 連續性',
        aiProvider: 'AI 提供者',
        failedToCopyClaudeCodeSessionId: '複製 Claude Code 工作階段 ID 失敗',
        failedToCopyCodexSessionId: '複製 Codex 工作階段 ID 失敗',
        failedToCopyCodexConversationId: '複製 Codex 對話 ID 失敗',
        ...
        worktreeCleanupFailed: ({ path }: { path: string }) => `工作樹清理失敗。可能需要手動刪除：${path}`,
        worktreeSection: '工作樹',
        worktreeBranch: '分支',
        worktreeBasePath: '基礎儲存庫',
        mergeToMain: '合併至主分支',
        mergeToMainSubtitle: '將此分支整合至基礎儲存庫',
    ...
    mergeWorktree: {
        title: '合併至主分支',
        preview: '待合併的變更',
        commits: ({ count }: { count: number }) => `${count} 個提交`,
        noChanges: '沒有可合併的變更',
        loadingDiff: '正在載入差異...',
        viewFullDiff: '查看完整差異',
        fullDiffTitle: '完整差異',
        squashMerge: 'Squash 合併（推薦）',
        regularMerge: '一般合併',
        squashDescription: '將所有提交合併為基礎分支上的一個乾淨提交',
        regularDescription: '保留工作樹分支的完整提交歷程',
        commitMessageLabel: '提交訊息',
        commitMessageDefault: ({ branchName }: { branchName: string }) => `代理任務: ${branchName}`,
        mergeButton: '合併',
        merging: '合併中...',
        successTitle: '合併成功',
        conflictTitle: '合併衝突',
        conflictMessage: '合併遇到衝突已被中止。請在終端機中手動解決衝突。',
        conflictFilesLabel: '衝突檔案',
        worktreeDirtyMessage: '工作樹有未提交的變更。請在合併前提交或捨棄這些變更。',
        baseDirtyMessage: '基礎儲存庫有未提交的變更。請在合併前提交或捨棄這些變更。',
        cleanupTitle: '清理工作樹？',
        cleanupMessage: '合併成功。是否要刪除工作樹目錄和分支？',
        cleanupConfirm: '刪除工作樹和分支',
        openspecUnarchivedTitle: '未封存的 OpenSpec 變更',
        openspecUnarchivedMessage: '以下 OpenSpec 變更尚未封存。建議在合併前先封存，以確保規格檔案是最新的：',
        openspecArchiveFirst: '先封存（推薦）',
        openspecProceedAnyway: '仍然繼續',
        specDivergenceTitle: '規格檔案已分歧',
        specDivergenceMessage: '自此工作樹分支以來，主分支上的 openspec/specs/ 目錄已被更新。現在合併可能會在規格檔案上產生衝突。',
        specPullResync: '拉取主分支並重新同步',
        specPullResyncDescription: '將主分支拉取至此分支，然後提示執行 /opsx:sync 以協調規格衝突。',
        specMergeAnyway: '仍然合併',
        specAfterPullMessage: '拉取主分支後，在此工作階段中執行 /opsx:sync 以解決規格衝突，然後重試合併。',
        pullMainSuccess: '主分支拉取成功。執行 /opsx:sync 以協調規格衝突。',
        pullMainFailed: '拉取主分支失敗',
        orphanTitle: '孤立工作樹',
        orphanNoSession: '無活躍工作階段',
        orphanCleanup: '清理',
        orphanCleanupAll: '全部清理',
        orphanDirtyTitle: '未提交的變更',
        ...
        mergeWithAI: '使用AI合併',
        mergeWithAISubtitle: '代理將檢查規格、處理衝突並合併至主分支',
        returnToMerge: '返回合併畫面',
        resolveWithAI: '使用AI解決',
        resolveWithAISubtitle: '以衝突解決提示恢復會話',
        syncSpecsWithAI: '使用AI同步規格',
        syncSpecsWithAISubtitle: '恢復會話以更新實作以符合當前規格',
        fetchingSpecDiff: '正在獲取規格差異...',
    },
} as const;
