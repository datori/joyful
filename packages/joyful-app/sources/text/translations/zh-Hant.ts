...
export const zhHant: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        joyfulSessionIdCopied: 'Joyful 工作階段 ID 已複製到剪貼簿',
        failedToCopySessionId: '複製 Joyful 工作階段 ID 失敗',
        joyfulSessionId: 'Joyful 工作階段 ID',
        ...
        updateCliInstructions: '請執行 npm install -g joyful@latest',
    ...
    machine: {
        ...
        offlineHelp: '• 確保您的電腦在線上\n• 執行 `joyful daemon status` 進行診斷\n• 您是否在執行最新的 CLI 版本？請使用 `npm install -g joyful@latest` 升級',
        daemon: '守護程序',
        status: '狀態',
        stopDaemon: '停止守護程序',
