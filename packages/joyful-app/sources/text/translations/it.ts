...
/**
 * Italian translations for the Joyful app
...
export const it: TranslationStructure = {
    ...
    inbox: {
        // Inbox screen
        emptyTitle: 'Nessun aggiornamento',
        emptyDescription: 'Sei aggiornato. Torna più tardi.',
    ...
    settings: {
        ...
        about: 'Informazioni',
        aboutFooter: 'Joyful Coder è un client mobile per Codex e Claude Code. È completamente cifrato end-to-end e il tuo account è memorizzato solo sul tuo dispositivo. Non affiliato con Anthropic.',
        whatsNew: 'Novità',
    ...
    settingsAppearance: {
        ...
        expandedSessionView: 'Vista sessioni espansa',
        expandedSessionViewDescription: 'Mostra le sessioni attive in un layout espanso',
    },
    ...
    errors: {
        ...
        voiceNotConfigured: 'Voce non configurata',
        voiceNotConfiguredDetail: 'La funzione vocale richiede un ID agente ElevenLabs. Vai su Impostazioni → Voce per configurarlo.',
        voiceServerNotConfigured: 'Voce non disponibile su questo server',
        voiceServerNotConfiguredDetail: 'L\'amministratore del server deve impostare ELEVENLABS_API_KEY per abilitare la voce.',
    ...
    newSession: {
        ...
        resumeNative: 'Riprendi',
        noMachinesFound: 'Nessuna macchina trovata. Avvia prima una sessione Joyful sul tuo computer.',
    ...
    session: {
        ...
        resumeSessionFailed: 'Impossibile riprendere la sessione. Assicurarsi che il daemon sia in esecuzione sulla macchina.',
    },
    ...
    server: {
        ...
        notValidHappyServer: 'Non è un Joyful Server valido',
    ...
    sessionInfo: {
        ...
        joyfulSessionIdCopied: 'ID sessione Joyful copiato negli appunti',
        failedToCopySessionId: 'Impossibile copiare l\'ID sessione Joyful',
        joyfulSessionId: 'ID sessione Joyful',
        ...
        updateCliInstructions: 'Esegui npm install -g joyful@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Installa la CLI Joyful',
            runIt: 'Avviala',
    ...
    nativeSessionResumePicker: {
        title: 'Riprendi sessione nativa',
        machinePlaceholder: 'Seleziona macchina',
        pathPlaceholder: 'Inserisci il percorso della directory…',
        findSessions: 'Trova sessioni',
        cancel: 'Annulla',
    },
    ...
    settingsVoice: {
        ...
        configurationTitle: 'Configurazione vocale',
        agentId: 'ID agente ElevenLabs',
        agentIdPlaceholder: 'Inserisci ID agente...',
        agentIdFooter: 'Inserisci l\'ID del tuo agente ElevenLabs Conversational AI. Per usare la voce, devi anche impostare ELEVENLABS_API_KEY sul server e configurare un agente con gli strumenti messageClaudeCode e processPermissionRequest.',
        configuredStatus: 'Configurato',
        notConfiguredStatus: 'Non configurato — tocca per configurare',
    },
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminale richiede di connettersi al tuo account Joyful Coder. Questo consentirà al terminale di inviare e ricevere messaggi in modo sicuro.',
    ...
    machine: {
        ...
        offlineHelp: '• Assicurati che il tuo computer sia online\n• Esegui `joyful daemon status` per diagnosticare\n• Stai usando l\'ultima versione della CLI? Aggiorna con `npm install -g joyful@latest`',
        daemon: 'Daemon',
        status: 'Stato',
        ...
        back: 'Indietro',
        memory: 'Memoria',
        memoryUsage: ({ used, total }: { used: string; total: string }) => `${used} / ${total} usati`,
    },
    ...
    openspec: {
        panelTitle: 'OpenSpec',
        activeChanges: ({ count }: { count: number }) => `Modifiche attive (${count})`,
        mainSpecs: ({ count }: { count: number }) => `Specifiche principali (${count})`,
        archived: ({ count }: { count: number }) => `Archiviati (${count})`,
        noActiveChanges: 'Nessuna modifica attiva',
        tasksProgress: ({ completed, total }: { completed: number; total: number }) => `${completed}/${total} attività`,
        noTasksFile: 'Nessun file attività',
        refreshing: 'Aggiornamento...',
        exploreMode: 'Modalità esplorazione',
        patchMode: 'Modalità patch',
        applyMode: 'Applica modifica',
        ffMode: 'Fast-Forward',
