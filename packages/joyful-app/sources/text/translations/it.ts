...
export const it: TranslationStructure = {
    ...
    newSession: {
        ...
        worktree: {
            ...
            pickWorktree: 'Seleziona Worktree',
            createNew: 'Crea nuova Worktree',
            existingWorktrees: 'Worktree esistenti',
            noActiveSession: 'Nessuna sessione attiva',
            loadingWorktrees: 'Caricamento worktree...',
            orphaned: 'Orfana',
        },
    ...
    sessionInfo: {
        ...
        codexConversationId: 'ID conversazione Codex',
        codexConversationIdCopied: 'ID conversazione Codex copiato negli appunti',
        codexContinuity: 'Continuita Codex',
        ...
        failedToCopyCodexConversationId: 'Impossibile copiare l\'ID conversazione Codex',
        ...
        worktreeCleanupFailed: ({ path }: { path: string }) => `Pulizia worktree non riuscita. Potrebbe essere necessario rimuoverla manualmente: ${path}`,
        worktreeSection: 'Worktree',
        worktreeBranch: 'Branch',
        worktreeBasePath: 'Repository base',
        mergeToMain: 'Unisci al principale',
        mergeToMainSubtitle: 'Consolida questo branch nel repository base',
    },
    ...
    mergeWorktree: {
        title: 'Unisci al principale',
        preview: 'Modifiche da unire',
        commits: ({ count }: { count: number }) => `${count} ${count !== 1 ? 'commit' : 'commit'}`,
        noChanges: 'Nessuna modifica da unire',
        loadingDiff: 'Caricamento diff...',
        viewFullDiff: 'Visualizza diff completo',
        fullDiffTitle: 'Diff completo',
        squashMerge: 'Unione squash (consigliato)',
        regularMerge: 'Unione regolare',
        squashDescription: 'Combina tutti i commit in uno pulito nel branch base',
        regularDescription: 'Conserva la cronologia completa dei commit dal branch worktree',
        commitMessageLabel: 'Messaggio di commit',
        commitMessageDefault: ({ branchName }: { branchName: string }) => `Attività agente: ${branchName}`,
        mergeButton: 'Unisci',
        merging: 'Unione in corso...',
        successTitle: 'Unione riuscita',
        conflictTitle: 'Conflitti di unione',
        conflictMessage: 'L\'unione ha incontrato conflitti ed è stata interrotta. Risolvili manualmente nel terminale.',
        conflictFilesLabel: 'File in conflitto',
        worktreeDirtyMessage: 'La worktree contiene modifiche non salvate. Salvatele o scartale prima di unire.',
        baseDirtyMessage: 'Il repository base contiene modifiche non salvate. Salvatele o scartale prima di unire.',
        cleanupTitle: 'Pulire la Worktree?',
        cleanupMessage: 'Unione riuscita. Vuoi rimuovere la directory worktree e il branch?',
        cleanupConfirm: 'Rimuovi worktree e branch',
        openspecUnarchivedTitle: 'Modifiche OpenSpec non archiviate',
        openspecUnarchivedMessage: 'Le seguenti modifiche OpenSpec non sono ancora archiviate. Valuta di archiviarle prima di unire per assicurarti che i file delle specifiche siano aggiornati:',
        openspecArchiveFirst: 'Archivia prima (consigliato)',
        openspecProceedAnyway: 'Procedi comunque',
        specDivergenceTitle: 'File di specifiche divergenti',
        specDivergenceMessage: 'La directory openspec/specs/ su main è stata aggiornata da quando è stato creato questo worktree. Unire ora causerebbe probabilmente conflitti nei file delle specifiche.',
        specPullResync: 'Scarica main e risincronizza',
        specPullResyncDescription: 'Scarica il branch principale in questo branch, quindi ti chiede di eseguire /opsx:sync per riconciliare eventuali conflitti nelle specifiche.',
        specMergeAnyway: 'Unisci comunque',
        specAfterPullMessage: 'Dopo aver scaricato main, esegui /opsx:sync in questa sessione per risolvere i conflitti nelle specifiche, poi riprova l\'unione.',
        pullMainSuccess: 'Branch principale scaricato con successo. Esegui /opsx:sync per riconciliare eventuali conflitti nelle specifiche.',
        pullMainFailed: 'Impossibile scaricare il branch principale',
        orphanTitle: 'Worktree orfane',
        orphanNoSession: 'Nessuna sessione attiva',
        orphanCleanup: 'Pulisci',
        orphanCleanupAll: 'Pulisci tutte',
        orphanDirtyTitle: 'Modifiche non salvate',
        ...
        syncSpecsWithAI: 'Sincronizza spec con AI',
        syncSpecsWithAISubtitle: 'Riprendi la sessione per aggiornare l\'implementazione secondo le spec attuali',
        fetchingSpecDiff: 'Recupero diff delle spec...',
    },
} as const;
