...
export const es: TranslationStructure = {
    ...
    newSession: {
        ...
        worktree: {
            ...
            pickWorktree: 'Seleccionar Worktree',
            createNew: 'Crear nuevo Worktree',
            existingWorktrees: 'Worktrees existentes',
            noActiveSession: 'Sin sesión activa',
            loadingWorktrees: 'Cargando worktrees...',
            orphaned: 'Huérfano',
        },
    ...
    sessionInfo: {
        ...
        codexConversationId: 'ID de conversación de Codex',
        codexConversationIdCopied: 'ID de conversación de Codex copiado al portapapeles',
        codexContinuity: 'Continuidad de Codex',
        ...
        failedToCopyCodexConversationId: 'Falló al copiar ID de conversación de Codex',
        ...
        worktreeCleanupFailed: ({ path }: { path: string }) => `Error al limpiar el worktree. Es posible que deba eliminarlo manualmente: ${path}`,
        worktreeSection: 'Worktree',
        worktreeBranch: 'Rama',
        worktreeBasePath: 'Repositorio base',
        mergeToMain: 'Fusionar con principal',
        mergeToMainSubtitle: 'Consolidar esta rama en el repositorio base',
    },
    ...
    mergeWorktree: {
        title: 'Fusionar con principal',
        preview: 'Cambios a fusionar',
        commits: ({ count }: { count: number }) => `${count} ${count !== 1 ? 'commits' : 'commit'}`,
        noChanges: 'No hay cambios para fusionar',
        loadingDiff: 'Cargando diff...',
        viewFullDiff: 'Ver diff completo',
        fullDiffTitle: 'Diff completo',
        squashMerge: 'Fusión squash (recomendado)',
        regularMerge: 'Fusión regular',
        squashDescription: 'Combina todos los commits en uno limpio en la rama base',
        regularDescription: 'Conserva el historial completo de commits de la rama worktree',
        commitMessageLabel: 'Mensaje de commit',
        commitMessageDefault: ({ branchName }: { branchName: string }) => `Tarea del agente: ${branchName}`,
        mergeButton: 'Fusionar',
        merging: 'Fusionando...',
        successTitle: 'Fusión exitosa',
        conflictTitle: 'Conflictos de fusión',
        conflictMessage: 'La fusión encontró conflictos y fue abortada. Resuélvalos manualmente en el terminal.',
        conflictFilesLabel: 'Archivos con conflictos',
        worktreeDirtyMessage: 'El worktree tiene cambios sin confirmar. Confírmelos o descártelos antes de fusionar.',
        baseDirtyMessage: 'El repositorio base tiene cambios sin confirmar. Confírmelos o descártelos antes de fusionar.',
        cleanupTitle: '¿Limpiar Worktree?',
        cleanupMessage: 'Fusión exitosa. ¿Desea eliminar el directorio worktree y la rama?',
        cleanupConfirm: 'Eliminar worktree y rama',
        openspecUnarchivedTitle: 'Cambios OpenSpec no archivados',
        openspecUnarchivedMessage: 'Los siguientes cambios de OpenSpec aún no están archivados. Considere archivarlos antes de fusionar para asegurar que los archivos de especificación estén actualizados:',
        openspecArchiveFirst: 'Archivar primero (recomendado)',
        openspecProceedAnyway: 'Continuar de todas formas',
        specDivergenceTitle: 'Archivos de especificación divergieron',
        specDivergenceMessage: 'El directorio openspec/specs/ en main ha sido actualizado desde que se ramificó este worktree. Fusionar ahora probablemente causaría conflictos en los archivos de especificación.',
        specPullResync: 'Extraer main y resincronizar',
        specPullResyncDescription: 'Extrae main en esta rama, luego le pide ejecutar /opsx:sync para reconciliar cualquier conflicto de especificación.',
        specMergeAnyway: 'Fusionar de todas formas',
        specAfterPullMessage: 'Después de extraer main, ejecute /opsx:sync en esta sesión para resolver conflictos de especificación, luego reintente la fusión.',
        pullMainSuccess: 'Rama principal extraída exitosamente. Ejecute /opsx:sync para reconciliar conflictos de especificación.',
        pullMainFailed: 'Error al extraer la rama principal',
        orphanTitle: 'Worktrees huérfanos',
        orphanNoSession: 'Sin sesión activa',
        orphanCleanup: 'Limpiar',
        orphanCleanupAll: 'Limpiar todos',
        orphanDirtyTitle: 'Cambios sin confirmar',
        orphanDirtyMessage: ({ path }: { path: string }) => `El worktree en ${path} tiene cambios sin confirmar que se perderán permanentemente.`,
        orphanCleanupSuccess: ({ name }: { name: string }) => `Worktree "${name}" eliminado`,
        orphanCleanupFailed: ({ name }: { name: string }) => `Error al eliminar worktree "${name}"`,
        mergeWithAI: 'Fusionar con IA',
        mergeWithAISubtitle: 'El agente comprobará las specs, resolverá conflictos y fusionará con main',
        returnToMerge: 'Volver a la pantalla de fusión',
        resolveWithAI: 'Resolver con IA',
        resolveWithAISubtitle: 'Reanudar la sesión con un prompt de resolución de conflictos',
        syncSpecsWithAI: 'Sincronizar specs con IA',
        syncSpecsWithAISubtitle: 'Reanudar la sesión para actualizar la implementación según las specs actuales',
        fetchingSpecDiff: 'Obteniendo diff de specs...',
    },
} as const;
