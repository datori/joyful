...
/**
 * Spanish translations for the Joyful app
...
export const es: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Acerca de',
        aboutFooter: 'Joyful Coder es un cliente móvil para Codex y Claude Code. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic.',
        whatsNew: 'Novedades',
    ...
    session: {
        ...
        resumeSessionFailed: 'No se pudo reanudar la sesión. Asegúrese de que el daemon esté ejecutándose en la máquina.',
    },
    ...
    server: {
        ...
        notValidHappyServer: 'No es un servidor Joyful válido',
    ...
    sessionInfo: {
        ...
        joyfulSessionIdCopied: 'ID de sesión de Joyful copiado al portapapeles',
        failedToCopySessionId: 'Falló al copiar ID de sesión de Joyful',
        joyfulSessionId: 'ID de sesión de Joyful',
        ...
        joyfulHome: 'Directorio de Joyful',
        ...
        updateCliInstructions: 'Por favor ejecute npm install -g joyful@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale el Joyful CLI',
            runIt: 'Ejecútelo',
    ...
    agentInput: {
        ...
        effort: {
            ...
            defaultDescription: 'Usar configuración de Claude',
            low: 'Bajo',
            medium: 'Medio',
            high: 'Alto',
            max: 'Máximo',
            badge: ({ level }: { level: string }) => `Esfuerzo: ${level}`,
        },
        codexPermissionMode: {
    ...
    nativeSessionBrowser: {
        title: 'Sesiones nativas',
        searchPlaceholder: 'Buscar sesiones…',
        resumeButton: 'Reanudar en Joyful',
        cancel: 'Cancelar',
        showAll: ({ count }: { count: number }) => `Mostrar todas (${count})`,
        showLess: 'Mostrar menos',
        noSessions: 'No se encontraron sesiones nativas de Claude para este directorio.',
        alreadyTracked: 'Ya en Joyful',
        browseNativeSessions: 'Explorar sesiones nativas',
    ...
    quota: {
        fiveHour: '5h',
        sevenDay: '7d',
        updatedAgo: ({ age }: { age: string }) => `actualizado hace ${age}`,
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal está solicitando conectarse a tu cuenta de Joyful Coder. Esto permitirá al terminal enviar y recibir mensajes de forma segura.',
    ...
    machine: {
        ...
        offlineHelp: '• Asegúrate de que tu computadora esté en línea\n• Ejecuta `joyful daemon status` para diagnosticar\n• ¿Estás usando la última versión del CLI? Actualiza con `npm install -g joyful@latest`',
    ...
    openspec: {
        panelTitle: 'OpenSpec',
        activeChanges: ({ count }: { count: number }) => `Cambios activos (${count})`,
        mainSpecs: ({ count }: { count: number }) => `Especificaciones principales (${count})`,
        archived: ({ count }: { count: number }) => `Archivados (${count})`,
        noActiveChanges: 'Sin cambios activos',
