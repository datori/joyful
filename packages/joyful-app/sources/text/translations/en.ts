...
export const en: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'About',
        aboutFooter: 'Joyful Coder is a Codex and Claude Code mobile client. It\'s fully end-to-end encrypted and your account is stored only on your device. Not affiliated with Anthropic.',
        whatsNew: 'What\'s New',
    ...
    newSession: {
        ...
        resumeNative: 'Resume',
        noMachinesFound: 'No machines found. Start a Joyful session on your computer first.',
        ...
        useDirectory: ({ path }: { path: string }) => `Use "${path}"`,
        hiddenDirsToggle: 'Show hidden',
        browseLoadError: 'Could not load directory',
    },
    ...
    server: {
        ...
        notValidHappyServer: 'Not a valid Joyful Server',
    ...
    sessionInfo: {
        ...
        joyfulSessionIdCopied: 'Joyful Session ID copied to clipboard',
        failedToCopySessionId: 'Failed to copy Joyful Session ID',
        joyfulSessionId: 'Joyful Session ID',
        ...
        codexConversationId: 'Codex Conversation ID',
        codexConversationIdCopied: 'Codex Conversation ID copied to clipboard',
        ...
        failedToCopyCodexConversationId: 'Failed to copy Codex Conversation ID',
        ...
        updateCliInstructions: 'Please run npm install -g joyful@latest',
        ...
        worktreeCleanupFailed: ({ path }: { path: string }) => `Worktree cleanup failed. You may need to manually remove: ${path}`,
        worktreeSection: 'Worktree',
        worktreeBranch: 'Branch',
        worktreeBasePath: 'Base Repository',
        mergeToMain: 'Merge to Main',
        mergeToMainSubtitle: 'Consolidate this branch into the base repository',
    },
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Install the Joyful CLI',
            runIt: 'Run it',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'A terminal is requesting to connect to your Joyful Coder account. This will allow the terminal to send and receive messages securely.',
    ...
    machine: {
        ...
        offlineHelp: '• Make sure your computer is online\n• Run `joyful daemon status` to diagnose\n• Are you running the latest CLI version? Upgrade with `npm install -g joyful@latest`',
        daemon: 'Daemon',
        status: 'Status',
    ...
    mergeWorktree: {
        // Used by MergeWorktreeModal and worktree merge flow
        title: 'Merge to Main',
        preview: 'Changes to Merge',
        commits: ({ count }: { count: number }) => `${count} commit${count !== 1 ? 's' : ''}`,
        noChanges: 'No changes to merge',
        loadingDiff: 'Loading diff...',
        viewFullDiff: 'View Full Diff',
        fullDiffTitle: 'Full Diff',
        squashMerge: 'Squash merge (recommended)',
        regularMerge: 'Regular merge',
        squashDescription: 'Combines all commits into one clean commit on the base branch',
        regularDescription: 'Preserves full commit history from the worktree branch',
        commitMessageLabel: 'Commit message',
        commitMessageDefault: ({ branchName }: { branchName: string }) => `Agent task: ${branchName}`,
        mergeButton: 'Merge',
        merging: 'Merging...',
        successTitle: 'Merge Successful',
        conflictTitle: 'Merge Conflicts',
        conflictMessage: 'The merge encountered conflicts and has been aborted. Resolve them manually in the terminal.',
        conflictFilesLabel: 'Conflicting files',
        worktreeDirtyMessage: 'The worktree has uncommitted changes. Please commit or discard them before merging.',
        baseDirtyMessage: 'The base repository has uncommitted changes. Please commit or discard them before merging.',
        cleanupTitle: 'Clean Up Worktree?',
        cleanupMessage: 'Merge successful. Would you like to remove the worktree directory and branch?',
        cleanupConfirm: 'Remove worktree and branch',
        openspecUnarchivedTitle: 'Unarchived OpenSpec Changes',
        openspecUnarchivedMessage: 'The following OpenSpec changes are not yet archived. Consider archiving them before merging to ensure spec files are current:',
        openspecArchiveFirst: 'Archive first (recommended)',
        openspecProceedAnyway: 'Proceed anyway',
        specDivergenceTitle: 'Spec Files Diverged',
        specDivergenceMessage: 'The openspec/specs/ directory on main has been updated since this worktree branched. Merging now would likely conflict on spec files.',
        specPullResync: 'Pull main and re-sync',
        specPullResyncDescription: 'Pulls main into this branch, then prompts you to run /opsx:sync to reconcile any spec conflicts.',
        specMergeAnyway: 'Merge anyway',
        specAfterPullMessage: 'After pulling main, run /opsx:sync in this session to resolve any spec conflicts, then retry the merge.',
        pullMainSuccess: 'Main branch pulled successfully. Run /opsx:sync to reconcile any spec conflicts.',
        pullMainFailed: 'Failed to pull main branch',
        orphanTitle: 'Orphaned Worktrees',
        orphanNoSession: 'No active session',
        orphanCleanup: 'Clean up',
        orphanCleanupAll: 'Clean up all',
        orphanDirtyTitle: 'Uncommitted Changes',
        ...
        syncSpecsWithAISubtitle: 'Resume the session to update the implementation to match current specs',
        fetchingSpecDiff: 'Fetching spec diff...',
    },
} as const;
