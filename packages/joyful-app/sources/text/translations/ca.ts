...
/**
 * Catalan translations for the Joyful app
...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Quant a',
        aboutFooter: 'Joyful Coder és un client mòbil de Codex i Claude Code. Tot està xifrat punt a punt i el teu compte es guarda només al teu dispositiu. No està afiliat amb Anthropic.',
        whatsNew: 'Novetats',
    ...
    server: {
        ...
        notValidHappyServer: 'No és un servidor Joyful vàlid',
    ...
    sessionInfo: {
        ...
        joyfulSessionIdCopied: 'ID de la sessió de Joyful copiat al porta-retalls',
        failedToCopySessionId: 'Ha fallat copiar l\'ID de la sessió de Joyful',
        joyfulSessionId: 'ID de la sessió de Joyful',
        ...
        joyfulHome: 'Directori de Joyful',
        ...
        updateCliInstructions: 'Si us plau executeu npm install -g joyful@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instal·la el Joyful CLI',
            runIt: 'Executa\'l',
    ...
    agentInput: {
        ...
        effort: {
            ...
            defaultDescription: 'Usar configuració de Claude',
            low: 'Baix',
            medium: 'Mitjà',
            high: 'Alt',
            max: 'Màxim',
            badge: ({ level }: { level: string }) => `Esforç: ${level}`,
        },
        codexPermissionMode: {
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal està sol·licitant connectar-se al teu compte de Joyful Coder. Això permetrà al terminal enviar i rebre missatges de forma segura.',
    ...
    machine: {
        ...
        offlineHelp: '• Assegura\'t que l\'ordinador estigui en línia\n• Executa `joyful daemon status` per diagnosticar\n• Fas servir l\'última versió del CLI? Actualitza amb `npm install -g joyful@latest`',
        ...
        back: 'Enrere',
        memory: 'Memòria',
        memoryUsage: ({ used, total }: { used: string; total: string }) => `${used} / ${total} usats`,
    },
    ...
    openspec: {
        ...
        exploreMode: 'Mode explorar',
        patchMode: 'Mode pedaç',
        applyMode: 'Aplicar canvi',
        ffMode: 'Fast-Forward',
        openPanel: 'Obrir panell',
    },
} as const;
