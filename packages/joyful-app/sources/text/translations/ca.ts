...
export const ca: TranslationStructure = {
    ...
    newSession: {
        ...
        worktree: {
            ...
            pickWorktree: 'Selecciona Worktree',
            createNew: 'Crea un nou Worktree',
            existingWorktrees: 'Worktrees existents',
            noActiveSession: 'Sense sessió activa',
            loadingWorktrees: 'Carregant worktrees...',
            orphaned: 'Orfe',
        },
    ...
    sessionInfo: {
        ...
        codexConversationId: 'ID de la conversa de Codex',
        codexConversationIdCopied: 'ID de la conversa de Codex copiat al porta-retalls',
        codexContinuity: 'Continuïtat de Codex',
        ...
        failedToCopyCodexConversationId: 'Ha fallat copiar l\'ID de la conversa de Codex',
        ...
        worktreeCleanupFailed: ({ path }: { path: string }) => `Error en netejar el worktree. Potser cal eliminar-lo manualment: ${path}`,
        worktreeSection: 'Worktree',
        worktreeBranch: 'Branca',
        worktreeBasePath: 'Repositori base',
        mergeToMain: 'Fusiona amb la principal',
        mergeToMainSubtitle: 'Consolida aquesta branca en el repositori base',
    },
    ...
    mergeWorktree: {
        title: 'Fusiona amb la principal',
        preview: 'Canvis a fusionar',
        commits: ({ count }: { count: number }) => `${count} ${count !== 1 ? 'commits' : 'commit'}`,
        noChanges: 'No hi ha canvis per fusionar',
        loadingDiff: 'Carregant diff...',
        viewFullDiff: 'Veure diff complet',
        fullDiffTitle: 'Diff complet',
        squashMerge: 'Fusió squash (recomanat)',
        regularMerge: 'Fusió regular',
        squashDescription: 'Combina tots els commits en un de net a la branca base',
        regularDescription: 'Preserva l\'historial complet de commits de la branca worktree',
        commitMessageLabel: 'Missatge de commit',
        commitMessageDefault: ({ branchName }: { branchName: string }) => `Tasca de l'agent: ${branchName}`,
        mergeButton: 'Fusiona',
        merging: 'Fusionant...',
        successTitle: 'Fusió correcta',
        conflictTitle: 'Conflictes de fusió',
        conflictMessage: 'La fusió ha trobat conflictes i s\'ha interromput. Resoleu-los manualment al terminal.',
        conflictFilesLabel: 'Fitxers amb conflictes',
        worktreeDirtyMessage: 'El worktree té canvis sense confirmar. Confirmeu-los o descarteu-los abans de fusionar.',
        baseDirtyMessage: 'El repositori base té canvis sense confirmar. Confirmeu-los o descarteu-los abans de fusionar.',
        cleanupTitle: 'Netejar Worktree?',
        cleanupMessage: 'Fusió correcta. Voleu eliminar el directori worktree i la branca?',
        cleanupConfirm: 'Elimina el worktree i la branca',
        openspecUnarchivedTitle: 'Canvis OpenSpec sense arxivar',
        openspecUnarchivedMessage: 'Els canvis OpenSpec següents encara no estan arxivats. Considereu arxivar-los abans de fusionar per assegurar que els fitxers d\'especificació estiguin actualitzats:',
        openspecArchiveFirst: 'Arxiva primer (recomanat)',
        openspecProceedAnyway: 'Continua igualment',
        specDivergenceTitle: 'Els fitxers d\'especificació han divergit',
        specDivergenceMessage: 'El directori openspec/specs/ a main s\'ha actualitzat des que es va ramificar aquest worktree. Fusionar ara probablement causaria conflictes als fitxers d\'especificació.',
        specPullResync: 'Obtén main i resincronitza',
        specPullResyncDescription: 'Obté la branca principal en aquesta branca i després demana executar /opsx:sync per reconciliar conflictes d\'especificació.',
        specMergeAnyway: 'Fusiona igualment',
        specAfterPullMessage: 'Després d\'obtenir main, executeu /opsx:sync en aquesta sessió per resoldre conflictes d\'especificació i torneu a intentar la fusió.',
        pullMainSuccess: 'La branca principal s\'ha obtingut correctament. Executeu /opsx:sync per reconciliar conflictes d\'especificació.',
        pullMainFailed: 'Error en obtenir la branca principal',
        orphanTitle: 'Worktrees orfes',
        orphanNoSession: 'Sense sessió activa',
        orphanCleanup: 'Neteja',
        orphanCleanupAll: 'Neteja tot',
        orphanDirtyTitle: 'Canvis sense confirmar',
        orphanDirtyMessage: ({ path }: { path: string }) => `El worktree a ${path} té canvis sense confirmar que es perdran permanentment.`,
        orphanCleanupSuccess: ({ name }: { name: string }) => `Worktree "${name}" eliminat`,
        orphanCleanupFailed: ({ name }: { name: string }) => `Error en eliminar el worktree "${name}"`,
        mergeWithAI: 'Fusiona amb IA',
        mergeWithAISubtitle: "L'agent comprovarà les specs, resoldrà conflictes i fusionarà amb main",
        returnToMerge: 'Torna a la pantalla de fusió',
        resolveWithAI: 'Resoldre amb IA',
        resolveWithAISubtitle: 'Reprèn la sessió amb un prompt de resolució de conflictes',
        syncSpecsWithAI: 'Sincronitzar specs amb IA',
        syncSpecsWithAISubtitle: 'Reprèn la sessió per actualitzar la implementació segons les specs actuals',
        fetchingSpecDiff: 'Obtenint diff de specs...',
    },
} as const;
