...
/**
 * Polish translations for the Joyful app
...
export const pl: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'O aplikacji',
        aboutFooter: 'Joyful Coder to mobilny klient Codex i Claude Code. Jest w pełni szyfrowany end-to-end, a Twoje konto jest przechowywane tylko na Twoim urządzeniu. Nie jest powiązany z Anthropic.',
        whatsNew: 'Co nowego',
    ...
    newSession: {
        ...
        resumeNative: 'Wznów',
        noMachinesFound: 'Nie znaleziono maszyn. Najpierw uruchom sesję Joyful na swoim komputerze.',
        ...
        worktree: {
            ...
            pickWorktree: 'Wybierz Worktree',
            createNew: 'Utwórz nowy Worktree',
            existingWorktrees: 'Istniejące Worktrees',
            noActiveSession: 'Brak aktywnej sesji',
            loadingWorktrees: 'Ładowanie worktrees...',
            orphaned: 'Osierocony',
        },
    ...
    server: {
        ...
        notValidHappyServer: 'To nie jest prawidłowy serwer Joyful',
    ...
    sessionInfo: {
        ...
        joyfulSessionIdCopied: 'ID sesji Joyful skopiowane do schowka',
        failedToCopySessionId: 'Nie udało się skopiować ID sesji Joyful',
        joyfulSessionId: 'ID sesji Joyful',
        ...
        codexConversationId: 'ID rozmowy Codex',
        codexConversationIdCopied: 'ID rozmowy Codex skopiowane do schowka',
        codexContinuity: 'Ciaglosc Codex',
        ...
        failedToCopyCodexConversationId: 'Nie udało się skopiować ID rozmowy Codex',
        ...
        joyfulHome: 'Katalog domowy Joyful',
        ...
        updateCliInstructions: 'Proszę uruchomić npm install -g joyful@latest',
        ...
        worktreeCleanupFailed: ({ path }: { path: string }) => `Czyszczenie worktree nie powiodło się. Konieczne może być ręczne usunięcie: ${path}`,
        worktreeSection: 'Worktree',
        worktreeBranch: 'Gałąź',
        worktreeBasePath: 'Bazowe repozytorium',
        mergeToMain: 'Scal z główną',
        mergeToMainSubtitle: 'Połącz tę gałąź z bazowym repozytorium',
    },
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Zainstaluj Joyful CLI',
            runIt: 'Uruchom je',
    ...
    agentInput: {
        ...
        effort: {
            title: 'WYSIŁEK',
            default: 'Domyślny',
            defaultDescription: 'Użyj ustawień Claude',
            low: 'Niski',
            medium: 'Średni',
            high: 'Wysoki',
            max: 'Maksymalny',
            badge: ({ level }: { level: string }) => `Wysiłek: ${level}`,
        },
        codexPermissionMode: {
    ...
    quota: {
        fiveHour: '5h',
        sevenDay: '7d',
        updatedAgo: ({ age }: { age: string }) => `zaktualizowano ${age} temu`,
        inTime: ({ time }: { time: string }) => `za ${time}`,
    },
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Terminal żąda połączenia z Twoim kontem Joyful Coder. Pozwoli to terminalowi bezpiecznie wysyłać i odbierać wiadomości.',
    ...
    machine: {
        ...
        offlineHelp: '• Upewnij się, że komputer jest online\n• Uruchom `joyful daemon status`, aby zdiagnozować\n• Czy używasz najnowszej wersji CLI? Zaktualizuj poleceniem `npm install -g joyful@latest`',
    ...
    openspec: {
        ...
        exploreMode: 'Tryb eksploracji',
        patchMode: 'Tryb łatki',
        applyMode: 'Zastosuj zmianę',
        ffMode: 'Szybki start',
    ...
    mergeWorktree: {
        title: 'Scal z główną',
        preview: 'Zmiany do scalenia',
        commits: ({ count }: { count: number }) => `${count} ${plural({ count, one: 'commit', few: 'commity', many: 'commitów' })}`,
        noChanges: 'Brak zmian do scalenia',
        loadingDiff: 'Ładowanie diff...',
        viewFullDiff: 'Pełny diff',
        fullDiffTitle: 'Pełny diff',
        squashMerge: 'Scalenie squash (zalecane)',
        regularMerge: 'Zwykłe scalenie',
        squashDescription: 'Łączy wszystkie commity w jeden czysty commit w gałęzi bazowej',
        regularDescription: 'Zachowuje pełną historię commitów z gałęzi worktree',
        commitMessageLabel: 'Wiadomość commitu',
        commitMessageDefault: ({ branchName }: { branchName: string }) => `Zadanie agenta: ${branchName}`,
        mergeButton: 'Scal',
        merging: 'Scalanie...',
        successTitle: 'Scalenie zakończone sukcesem',
        conflictTitle: 'Konflikty scalenia',
        conflictMessage: 'Scalenie napotkało konflikty i zostało przerwane. Rozwiąż je ręcznie w terminalu.',
        conflictFilesLabel: 'Pliki z konfliktami',
        worktreeDirtyMessage: 'Worktree zawiera niezatwierdzone zmiany. Zatwierdź lub odrzuć je przed scaleniem.',
        baseDirtyMessage: 'Bazowe repozytorium zawiera niezatwierdzone zmiany. Zatwierdź lub odrzuć je przed scaleniem.',
        cleanupTitle: 'Wyczyścić Worktree?',
        cleanupMessage: 'Scalenie zakończone sukcesem. Chcesz usunąć katalog worktree i gałąź?',
        cleanupConfirm: 'Usuń worktree i gałąź',
        openspecUnarchivedTitle: 'Niearchiwizowane zmiany OpenSpec',
        openspecUnarchivedMessage: 'Następujące zmiany OpenSpec nie są jeszcze zarchiwizowane. Rozważ ich archiwizację przed scaleniem, aby pliki specyfikacji były aktualne:',
        openspecArchiveFirst: 'Najpierw archiwizuj (zalecane)',
        openspecProceedAnyway: 'Kontynuuj mimo to',
        specDivergenceTitle: 'Pliki specyfikacji się rozbieżne',
        specDivergenceMessage: 'Katalog openspec/specs/ w głównej gałęzi został zaktualizowany od momentu odgałęzienia tego worktree. Scalenie teraz prawdopodobnie spowoduje konflikty w plikach specyfikacji.',
        specPullResync: 'Pobierz main i zsynchronizuj ponownie',
        specPullResyncDescription: 'Pobiera główną gałąź do tej gałęzi, a następnie prosi o uruchomienie /opsx:sync w celu rozwiązania konfliktów specyfikacji.',
        specMergeAnyway: 'Scal mimo to',
        specAfterPullMessage: 'Po pobraniu głównej gałęzi uruchom /opsx:sync w tej sesji, aby rozwiązać konflikty specyfikacji, a następnie ponów scalenie.',
        pullMainSuccess: 'Główna gałąź pobrana pomyślnie. Uruchom /opsx:sync, aby rozwiązać konflikty specyfikacji.',
        pullMainFailed: 'Nie udało się pobrać głównej gałęzi',
        orphanTitle: 'Osierocone Worktrees',
        orphanNoSession: 'Brak aktywnej sesji',
        orphanCleanup: 'Wyczyść',
        orphanCleanupAll: 'Wyczyść wszystkie',
        orphanDirtyTitle: 'Niezatwierdzone zmiany',
        orphanDirtyMessage: ({ path }: { path: string }) => `Worktree w ${path} zawiera niezatwierdzone zmiany, które zostaną trwale utracone.`,
        orphanCleanupSuccess: ({ name }: { name: string }) => `Worktree "${name}" usunięty`,
        orphanCleanupFailed: ({ name }: { name: string }) => `Nie udało się usunąć worktree "${name}"`,
        mergeWithAI: 'Scal z AI',
        mergeWithAISubtitle: 'Agent sprawdzi specyfikacje, rozwiąże konflikty i scali do głównej',
        returnToMerge: 'Wróć do ekranu scalania',
        resolveWithAI: 'Rozwiąż z AI',
        resolveWithAISubtitle: 'Wznów sesję z promptem do rozwiązywania konfliktów',
        syncSpecsWithAI: 'Synchronizuj specyfikacje z AI',
        syncSpecsWithAISubtitle: 'Wznów sesję, aby zaktualizować implementację zgodnie z aktualnymi specyfikacjami',
        fetchingSpecDiff: 'Pobieranie diff specyfikacji...',
    },
} as const;
