/**
 * Japanese translations for the Joyful app
 * Values can be:
...
export const ja: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'このアプリについて',
        aboutFooter: 'Joyful CoderはCodexとClaude Codeのモバイルクライアントです。完全なエンドツーエンド暗号化を採用し、アカウントはデバイスにのみ保存されます。Anthropicとは提携していません。',
        whatsNew: '新機能',
    ...
    newSession: {
        ...
        title: '新しいセッションを開始',
        resumeNative: '再開',
        noMachinesFound: 'マシンが見つかりません。まずコンピューターでJoyfulセッションを起動してください。',
    ...
    server: {
        ...
        notValidHappyServer: '有効なJoyful Serverではありません',
    ...
    sessionInfo: {
        ...
        joyfulSessionIdCopied: 'Joyful Session IDがクリップボードにコピーされました',
        failedToCopySessionId: 'Joyful Session IDのコピーに失敗しました',
        ...
        updateCliInstructions: 'npm install -g joyful@latest を実行してください',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'ターミナルがJoyful Coderアカウントへの接続を要求しています。これにより、ターミナルは安全にメッセージを送受信できるようになります。',
    ...
    machine: {
        ...
        offlineHelp: '• コンピューターがオンラインであることを確認してください\n• `joyful daemon status`を実行して診断してください\n• 最新のCLIバージョンを使用していますか？`npm install -g joyful@latest`でアップグレードしてください',
        daemon: 'デーモン',
        status: 'ステータス',
        stopDaemon: 'デーモンを停止',
