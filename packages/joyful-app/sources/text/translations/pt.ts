...
/**
 * Portuguese (Brazilian) translations for the Joyful app
...
export const pt: TranslationStructure = {
    ...
    inbox: {
        // Inbox screen
        emptyTitle: 'Sem atualizações',
        emptyDescription: 'Você está em dia. Volte mais tarde.',
    ...
    settings: {
        ...
        about: 'Sobre',
        aboutFooter: 'Joyful Coder é um cliente móvel para Codex e Claude Code. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo. Não é afiliado à Anthropic.',
        whatsNew: 'Novidades',
    ...
    settingsAppearance: {
        ...
        expandedSessionView: 'Visualização expandida de sessões',
        expandedSessionViewDescription: 'Mostrar sessões ativas em um layout expandido',
    },
    ...
    errors: {
        ...
        voiceNotConfiguredDetail: 'A função de voz requer um ID de agente ElevenLabs. Acesse Configurações → Voz para configurá-lo.',
        voiceServerNotConfigured: 'Voz não disponível neste servidor',
        voiceServerNotConfiguredDetail: 'O administrador do servidor precisa definir ELEVENLABS_API_KEY para habilitar a voz.',
    ...
    newSession: {
        ...
        resumeNative: 'Retomar',
        noMachinesFound: 'Nenhuma máquina encontrada. Inicie uma sessão Joyful no seu computador primeiro.',
        ...
        browseFilesystem: 'Explorar sistema de arquivos',
        browseTitle: 'Explorar',
        parentFolder: 'Pasta pai',
        useDirectory: ({ path }: { path: string }) => `Usar "${path}"`,
        hiddenDirsToggle: 'Mostrar ocultos',
        browseLoadError: 'Não foi possível carregar o diretório',
    },
    ...
    server: {
        ...
        notValidHappyServer: 'Não é um servidor Joyful válido',
    ...
    sessionInfo: {
        ...
        joyfulSessionIdCopied: 'ID da sessão Joyful copiado para a área de transferência',
        failedToCopySessionId: 'Falha ao copiar ID da sessão Joyful',
        joyfulSessionId: 'ID da sessão Joyful',
        ...
        updateCliInstructions: 'Por favor execute npm install -g joyful@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale o Joyful CLI',
            runIt: 'Execute',
    ...
    agentInput: {
        ...
        effort: {
            title: 'ESFORÇO',
            default: 'Padrão',
            defaultDescription: 'Usar configurações do Claude',
            low: 'Baixo',
            medium: 'Médio',
            high: 'Alto',
            max: 'Máximo',
            badge: ({ level }: { level: string }) => `Esforço: ${level}`,
        },
        codexPermissionMode: {
    ...
    nativeSessionResumePicker: {
        title: 'Retomar sessão nativa',
        machinePlaceholder: 'Selecionar máquina',
        pathPlaceholder: 'Inserir caminho do diretório…',
        findSessions: 'Encontrar sessões',
        cancel: 'Cancelar',
    },

    nativeSessionBrowser: {
        title: 'Sessões nativas',
        searchPlaceholder: 'Pesquisar sessões…',
        resumeButton: 'Retomar no Joyful',
        cancel: 'Cancelar',
        showAll: ({ count }: { count: number }) => `Mostrar todas (${count})`,
        showLess: 'Mostrar menos',
        noSessions: 'Nenhuma sessão nativa do Claude encontrada para este diretório.',
        alreadyTracked: 'Já no Joyful',
        browseNativeSessions: 'Explorar sessões nativas',
    ...
    settingsVoice: {
        ...
        configurationTitle: 'Configuração de voz',
        agentId: 'ID do agente ElevenLabs',
        agentIdPlaceholder: 'Digite o ID do agente...',
        agentIdFooter: 'Digite o ID do seu agente ElevenLabs Conversational AI. Para usar voz, você também precisa definir ELEVENLABS_API_KEY no servidor e configurar um agente com as ferramentas messageClaudeCode e processPermissionRequest.',
        configuredStatus: 'Configurado',
        notConfiguredStatus: 'Não configurado — toque para configurar',
    },
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Um terminal está solicitando conexão à sua conta Joyful Coder. Isso permitirá que o terminal envie e receba mensagens com segurança.',
    ...
    machine: {
        ...
        offlineHelp: '• Verifique se seu computador está online\n• Execute `joyful daemon status` para diagnosticar\n• Você está usando a versão mais recente do CLI? Atualize com `npm install -g joyful@latest`',
        ...
        back: 'Voltar',
        memory: 'Memória',
        memoryUsage: ({ used, total }: { used: string; total: string }) => `${used} / ${total} usados`,
    },
    ...
    openspec: {
        ...
        patchMode: 'Modo patch',
        applyMode: 'Aplicar mudança',
        ffMode: 'Fast-Forward',
