...
export const pt: TranslationStructure = {
    ...
    newSession: {
        ...
        worktree: {
            ...
            pickWorktree: 'Selecionar Worktree',
            createNew: 'Criar novo Worktree',
            existingWorktrees: 'Worktrees existentes',
    ...
    sessionInfo: {
        ...
        codexConversationId: 'ID da conversa Codex',
        codexConversationIdCopied: 'ID da conversa Codex copiado para a área de transferência',
        codexContinuity: 'Continuidade do Codex',
        ...
        failedToCopyCodexConversationId: 'Falha ao copiar ID da conversa Codex',
        ...
        worktreeCleanupFailed: ({ path }: { path: string }) => `Falha ao limpar o worktree. Talvez seja necessário removê-lo manualmente: ${path}`,
        worktreeSection: 'Worktree',
        worktreeBranch: 'Branch',
        worktreeBasePath: 'Repositório base',
        mergeToMain: 'Mesclar na principal',
        mergeToMainSubtitle: 'Consolidar este branch no repositório base',
    },
    ...
    mergeWorktree: {
        title: 'Mesclar na principal',
        preview: 'Alterações a mesclar',
        commits: ({ count }: { count: number }) => `${count} ${count !== 1 ? 'commits' : 'commit'}`,
        noChanges: 'Sem alterações para mesclar',
        loadingDiff: 'Carregando diff...',
        viewFullDiff: 'Ver diff completo',
        fullDiffTitle: 'Diff completo',
        squashMerge: 'Mesclagem squash (recomendado)',
        regularMerge: 'Mesclagem regular',
        squashDescription: 'Combina todos os commits em um único commit limpo no branch base',
        regularDescription: 'Preserva o histórico completo de commits do branch worktree',
        commitMessageLabel: 'Mensagem de commit',
        commitMessageDefault: ({ branchName }: { branchName: string }) => `Tarefa do agente: ${branchName}`,
        mergeButton: 'Mesclar',
        merging: 'Mesclando...',
        successTitle: 'Mesclagem concluída',
        conflictTitle: 'Conflitos de mesclagem',
        conflictMessage: 'A mesclagem encontrou conflitos e foi abortada. Resolva-os manualmente no terminal.',
        conflictFilesLabel: 'Arquivos com conflitos',
        worktreeDirtyMessage: 'O worktree possui alterações não confirmadas. Confirme ou descarte-as antes de mesclar.',
        baseDirtyMessage: 'O repositório base possui alterações não confirmadas. Confirme ou descarte-as antes de mesclar.',
        cleanupTitle: 'Limpar Worktree?',
        cleanupMessage: 'Mesclagem concluída. Deseja remover o diretório worktree e o branch?',
        cleanupConfirm: 'Remover worktree e branch',
        openspecUnarchivedTitle: 'Alterações OpenSpec não arquivadas',
        openspecUnarchivedMessage: 'As seguintes alterações do OpenSpec ainda não foram arquivadas. Considere arquivá-las antes de mesclar para garantir que os arquivos de especificação estejam atualizados:',
        openspecArchiveFirst: 'Arquivar primeiro (recomendado)',
        openspecProceedAnyway: 'Continuar assim mesmo',
        specDivergenceTitle: 'Arquivos de especificação divergiram',
        specDivergenceMessage: 'O diretório openspec/specs/ no main foi atualizado desde que este worktree foi criado. Mesclar agora provavelmente causaria conflitos nos arquivos de especificação.',
        specPullResync: 'Puxar main e ressincronizar',
        specPullResyncDescription: 'Puxa o branch principal neste branch e então solicita executar /opsx:sync para reconciliar conflitos de especificação.',
        specMergeAnyway: 'Mesclar assim mesmo',
        specAfterPullMessage: 'Após puxar o main, execute /opsx:sync nesta sessão para resolver conflitos de especificação e tente a mesclagem novamente.',
        pullMainSuccess: 'Branch principal puxado com sucesso. Execute /opsx:sync para reconciliar conflitos de especificação.',
        pullMainFailed: 'Falha ao puxar o branch principal',
        orphanTitle: 'Worktrees órfãos',
        orphanNoSession: 'Sem sessão ativa',
        orphanCleanup: 'Limpar',
        orphanCleanupAll: 'Limpar todos',
        orphanDirtyTitle: 'Alterações não confirmadas',
        ...
        mergeWithAI: 'Mesclar com IA',
        mergeWithAISubtitle: 'O agente verificará as specs, resolverá conflitos e mesclará com main',
        returnToMerge: 'Voltar à tela de mesclagem',
