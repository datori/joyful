...
/**
 * Russian translations for the Joyful app
...
export const ru: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'О программе',
        aboutFooter: 'Joyful Coder — мобильное приложение для работы с Codex и Claude Code. Использует сквозное шифрование, все данные аккаунта хранятся только на вашем устройстве. Не связано с Anthropic.',
        whatsNew: 'Что нового',
    ...
    newSession: {
        ...
        noMachinesFound: 'Машины не найдены. Сначала запустите сессию Joyful на вашем компьютере.',
        ...
        worktree: {
            ...
            pickWorktree: 'Выбрать Worktree',
            createNew: 'Создать новый Worktree',
            existingWorktrees: 'Существующие Worktrees',
            noActiveSession: 'Нет активной сессии',
            loadingWorktrees: 'Загрузка worktrees...',
    ...
    server: {
        ...
        notValidHappyServer: 'Это не валидный сервер Joyful',
    ...
    sessionInfo: {
        ...
        joyfulSessionIdCopied: 'ID сессии Joyful скопирован в буфер обмена',
        failedToCopySessionId: 'Не удалось скопировать ID сессии Joyful',
        joyfulSessionId: 'ID сессии Joyful',
        ...
        codexConversationId: 'ID разговора Codex',
        codexConversationIdCopied: 'ID разговора Codex скопирован в буфер обмена',
        codexContinuity: 'Непрерывность Codex',
        ...
        failedToCopyCodexConversationId: 'Не удалось скопировать ID разговора Codex',
        ...
        joyfulHome: 'Домашний каталог Joyful',
        ...
        updateCliInstructions: 'Пожалуйста, выполните npm install -g joyful@latest',
        ...
        worktreeCleanupFailed: ({ path }: { path: string }) => `Не удалось очистить worktree. Возможно, придётся удалить вручную: ${path}`,
        worktreeSection: 'Worktree',
        worktreeBranch: 'Ветка',
        worktreeBasePath: 'Базовый репозиторий',
        mergeToMain: 'Слить в основную',
        mergeToMainSubtitle: 'Объединить эту ветку с базовым репозиторием',
    },
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Установите Joyful CLI',
            runIt: 'Запустите его',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Терминал запрашивает подключение к вашему аккаунту Joyful Coder. Это позволит терминалу безопасно отправлять и получать сообщения.',
    ...
    machine: {
        ...
        offlineHelp: '• Убедитесь, что компьютер online\n• Выполните `joyful daemon status` для диагностики\n• Используете последнюю версию CLI? Обновите командой `npm install -g joyful@latest`',
        ...
        back: 'Назад',
        memory: 'Память',
        memoryUsage: ({ used, total }: { used: string; total: string }) => `${used} / ${total} используется`,
    },
    ...
    mergeWorktree: {
        title: 'Слить в основную',
        preview: 'Изменения для слияния',
        commits: ({ count }: { count: number }) => `${count} ${plural({ count, one: 'коммит', few: 'коммита', many: 'коммитов' })}`,
        noChanges: 'Нет изменений для слияния',
        loadingDiff: 'Загрузка diff...',
        viewFullDiff: 'Посмотреть полный diff',
        fullDiffTitle: 'Полный diff',
        squashMerge: 'Сжатое слияние (рекомендуется)',
        regularMerge: 'Обычное слияние',
        squashDescription: 'Объединяет все коммиты в один чистый коммит в базовой ветке',
        regularDescription: 'Сохраняет полную историю коммитов из ветки worktree',
        commitMessageLabel: 'Сообщение коммита',
        commitMessageDefault: ({ branchName }: { branchName: string }) => `Задача агента: ${branchName}`,
        mergeButton: 'Слить',
        merging: 'Слияние...',
        successTitle: 'Слияние выполнено',
        conflictTitle: 'Конфликты слияния',
        conflictMessage: 'Слияние прервано из-за конфликтов. Разрешите их вручную в терминале.',
        conflictFilesLabel: 'Конфликтующие файлы',
        worktreeDirtyMessage: 'Worktree содержит незафиксированные изменения. Зафиксируйте или отмените их перед слиянием.',
        baseDirtyMessage: 'Базовый репозиторий содержит незафиксированные изменения. Зафиксируйте или отмените их перед слиянием.',
        cleanupTitle: 'Очистить Worktree?',
        cleanupMessage: 'Слияние выполнено. Удалить директорию worktree и ветку?',
        cleanupConfirm: 'Удалить worktree и ветку',
        openspecUnarchivedTitle: 'Неархивированные изменения OpenSpec',
        openspecUnarchivedMessage: 'Следующие изменения OpenSpec ещё не архивированы. Рекомендуется архивировать их перед слиянием, чтобы файлы спецификаций были актуальны:',
        openspecArchiveFirst: 'Сначала архивировать (рекомендуется)',
        openspecProceedAnyway: 'Всё равно продолжить',
        specDivergenceTitle: 'Файлы спецификаций разошлись',
        specDivergenceMessage: 'Директория openspec/specs/ в основной ветке была обновлена после ответвления этого worktree. Слияние сейчас, вероятно, приведёт к конфликтам в файлах спецификаций.',
        specPullResync: 'Подтянуть основную и пересинхронизировать',
        specPullResyncDescription: 'Подтягивает основную ветку в эту ветку, затем предлагает выполнить /opsx:sync для разрешения конфликтов спецификаций.',
        specMergeAnyway: 'Слить в любом случае',
        specAfterPullMessage: 'После подтягивания основной ветки выполните /opsx:sync в этой сессии для разрешения конфликтов спецификаций, затем повторите слияние.',
        pullMainSuccess: 'Основная ветка успешно подтянута. Выполните /opsx:sync для разрешения конфликтов спецификаций.',
        pullMainFailed: 'Не удалось подтянуть основную ветку',
        orphanTitle: 'Осиротевшие Worktrees',
        orphanNoSession: 'Нет активной сессии',
        orphanCleanup: 'Очистить',
        orphanCleanupAll: 'Очистить все',
        orphanDirtyTitle: 'Незафиксированные изменения',
        ...
        mergeWithAI: 'Слить с помощью ИИ',
        mergeWithAISubtitle: 'Агент проверит спецификации, разрешит конфликты и выполнит слияние',
        ...
        syncSpecsWithAISubtitle: 'Возобновить сессию для обновления реализации в соответствии с текущими спецификациями',
        fetchingSpecDiff: 'Получение diff спецификаций...',
    },
} as const;
