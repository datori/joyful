            ...
            <View style={styles.container}>
                ...
                <View style={{justifyContent: 'flex-end' }}>
                    <Text style={styles.secondInstructionText}>
                        {t('restore.linkDeviceInstructions')}
                    </Text>
                </View>
                {!authReady && (
                ...
                {authReady && (
                    <QRCode
                        data={'joyful:///account?' + encodeBase64(keypair.publicKey, 'base64url')}
                        size={300}
                ...
                <View style={{ flexGrow: 4, paddingTop: 30 }}>
                    <RoundButton title={t('restore.restoreWithSecretKey')} display='inverted' onPress={() => {
