...
export default function ClaudeOAuth() {
    ...
    return (
        <>
            <OAuthViewUnsupported name="Claude" command="joyful connect claude" />
            {/* <OAuthView
                name="Claude"
                command="joyful connect claude"
...
const OAuthViewUnsupported = React.memo((props: {
    ...
    const command = props.command || `joyful connect ${props.name.toLowerCase()}`;
