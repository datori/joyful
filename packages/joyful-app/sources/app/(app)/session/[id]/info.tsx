...
function SessionInfoContent({ session }: { session: Session }) {
    ...
    const handleCopySessionId = useCallback(async () => {
        ...
        try {
            ...
            Modal.alert(t('common.success'), t('sessionInfo.joyfulSessionIdCopied'));
        } catch (error) {
    ...
    const handleCopyUpdateCommand = useCallback(async () => {
        const updateCommand = 'npm install -g joyful@latest';
        try {
            ...
            <ItemList>
                ...
                {session.metadata && (
                    <ItemGroup title={t('sessionInfo.metadata')}>
                        ...
                        {session.metadata.joyfulHomeDir && (
                            <Item
                                title={t('sessionInfo.joyfulHome')}
                                subtitle={formatPathRelativeToHome(session.metadata.joyfulHomeDir, session.metadata.homeDir)}
