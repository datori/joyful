...
export default function FriendsScreen() {
    ...
    const [acceptLoading, doAccept] = useJoyfulAction(async () => {
    ...
    const [rejectLoading, doReject] = useJoyfulAction(async () => {
        if (!credentials || !processingId) return;
    ...
    const [removeLoading, doRemove] = useJoyfulAction(async () => {
        if (!credentials || !processingId) return;
