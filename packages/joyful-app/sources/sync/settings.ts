 ...
 *    Example: Z_AI_AUTH_TOKEN=sk-real-key Z_AI_BASE_URL=https://api.z.ai joyful daemon start
 *
...
export const SettingsSchema = z.object({
    ...
    elevenLabsAgentId: z.string().nullish().describe('ElevenLabs Conversational AI agent ID for self-hosted voice (null/undefined = use build-time or env var config)'),
