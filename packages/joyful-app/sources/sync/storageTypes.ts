...
export const MetadataSchema = z.object({
    ...
    joyfulHomeDir: z.string().optional(), // Happy configuration directory 
...
export const MachineMetadataSchema = z.object({
    ...
    joyfulHomeDir: z.string(), // Directory for Joyful auth, settings, logs (usually .joyful/ or .joyful-dev/)
    ...
    shutdownSource: z.enum(['joyful-app', 'joyful-cli', 'os-signal', 'unknown']).optional()
});
