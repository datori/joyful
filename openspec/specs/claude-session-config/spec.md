# claude-session-config Specification

## Purpose
Defines how Claude Code session configuration (model selection, reasoning effort level) flows between the app and CLI, and how the CLI serves as the source of truth for available options.
